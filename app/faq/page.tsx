...
const faqCategories = [
    {
        ...
        faqs: [
            {
                question: "How do I book Velstays?",
                answer:
        ...
        faqs: [
            {
                ...
                answer:
                    "Velstays House 23 comfortably accommodates up to 3 guests with 2 bedrooms, 2 beds, and 2 bathrooms.",
            },
            {
        ...
        faqs: [
            {
                ...
                answer:
                    "Velstays House 23 is located in Kicukiro, Kigali, Rwanda — a peaceful residential neighborhood with easy access to the city center, restaurants, and coffee shops.",
            },
            {
        ...
        faqs: [
            {
                ...
                answer:
                    "Yes, Velstays is located in a very safe, quiet, and secure residential neighborhood. Rwanda is widely recognized as one of the safest countries in Africa.",
            },
            {
            ...
            <div className="bg-background pt-28 pb-20 px-4 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-3xl">
                    ...
                    <p className="text-muted-foreground text-lg mb-12">
                        Find answers to common questions about staying at Velstays. Can&apos;t find what you&apos;re looking for? Contact the host directly.
                    </p>
