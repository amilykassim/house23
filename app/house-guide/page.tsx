        ...
        items: [
            {
                ...
                emoji: "👨‍🍳",
                title: "Oven & Stove",
                subtitle: "Channel your inner chef",
                ...
                steps: [
                    ...
                    { label: "Light the burner", detail: "Turn the knob to ignition and press down. Hold 3 seconds until the flame catches. Blue flame = perfect!", icon: <Zap className="h-4 w-4 text-orange-500" /> },
                    { label: "Use the oven", detail: "Set the dial to your desired temp. Wait ~10 min to preheat — the indicator light turns off when ready.", icon: <CookingPot className="h-4 w-4 text-orange-500" /> },
            ...
            },
            {
                ...
                steps: [
                    { label: "Fill the kettle", detail: "Fill up to the MAX line. Use filtered water from the dispenser if available.", icon: <Droplets className="h-4 w-4 text-amber-600" /> },
                    { label: "Flip the switch", detail: "Set the kettle on its base and switch on. The indicator light glows.", icon: <Power className="h-4 w-4 text-amber-600" /> },
                    { label: "Wait for the click", detail: "Auto shut-off when boiled — a satisfying click! Takes ~2-3 minutes.", icon: <Zap className="h-4 w-4 text-amber-600" /> },
                    { label: "Brew & enjoy", detail: "Premium Rwandan coffee & tea provided. Use the French press or pour over a coffee bag. Milk's in the fridge!", icon: <Coffee className="h-4 w-4 text-amber-600" /> },
                ],
