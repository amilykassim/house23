...
export const metadata: Metadata = {
    title: "Privacy Policy | Velstays",
    description: "Privacy policy for Velstays. Learn how we handle your personal information.",
}
                    ...
                    <div className="prose prose-neutral dark:prose-invert max-w-none space-y-10">
                        ...
                        <section>
                            ...
                            <p className="text-muted-foreground leading-relaxed mt-3">
                                To exercise any of these rights, please contact us at hello@velstays.com.
                            </p>
                        </section>
