            ...
            <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
                ...
                <div className="bg-card rounded-2xl border border-border shadow-sm overflow-hidden">
                    ...
                    {loading ? (
                        ...
                        ${isCurrentMonth && !isPast && !isBlocked && !isSelected ? "text-foreground hover:bg-muted cursor-pointer" : ""}
                        ${isBlocked && isCurrentMonth && !isPast && !isSelected ? "bg-red-500/15 text-red-600 dark:text-red-400 font-medium" : ""}
                      ...
                      `}
                                        >
                                            ...
                                            {isBlocked && isCurrentMonth && !isPast && !isSelected && (
